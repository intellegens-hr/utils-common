...
`DbContext` is required to access database, `IMapper` (Automapper interface) should contain mapping between DTO and entity, `ISearchServiceFactory` is used to generate queries for filtering entire dataset.
