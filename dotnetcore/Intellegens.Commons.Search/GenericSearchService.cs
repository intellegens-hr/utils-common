...
namespace Intellegens.Commons.Search
{
    ...
    public partial class GenericSearchService<T> : IGenericSearchService<T> where T : class, new()
    {
        ...
        /// </summary>
        public IEnumerable<string> FullTextSearchPaths { get; set; } = FullTextSearchExtensions.GetFullTextSearchPaths<T>();
        ...
        /// <param name="searchRequest"></param>
        /// <returns></returns>
        public Task<IList<T>> Search(IEnumerable<T> sourceData, SearchRequest searchRequest)
        ...
        /// <param name="searchRequest"></param>
        /// <returns></returns>
        public async Task<IList<T>> Search(IQueryable<T> sourceData, SearchRequest searchRequest)
            => await FilterQuery(sourceData, searchRequest)
        ...
        /// <param name="searchRequest"></param>
        /// <returns></returns>
        public async Task<(int count, IEnumerable<T> data)> SearchAndCount(IQueryable<T> sourceData, SearchRequest searchRequest)
        {
        ...
        /// <param name="searchRequest"></param>
        /// <returns></returns>
        public Task<(int count, IEnumerable<T> data)> SearchAndCount(IEnumerable<T> sourceData, SearchRequest searchRequest)
